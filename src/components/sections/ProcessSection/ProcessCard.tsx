...
export default function ProcessCard({details}:{details: ProcessDetails}) {
  return (
    <div className="w-full bg-[#1C1C1C] border border-[#3C3C3C] rounded-xl p-6 2xl:p-8">
      <div>
        <div className="w-12 h-12 rounded-lg black-bg border border-[#3C3C3C] flex-center mb-15 2xl:mb-35 white-text">
          {details.sl}
        </div>
